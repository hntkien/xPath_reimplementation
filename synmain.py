...
from utils import load_xpath, filter_test_nodes
...
#         if label[i].item() == pred_list[str(target_id)]:
...
if __name__ == "__main__": 
    ...
    # TODO: Extract all the labels from the graph 
